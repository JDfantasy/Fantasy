...
-(void)drawRadialGradient:(CGContextRef)context{
    ...
    [UIColor colorWithRed:0.845 green:0.812 blue:0.854 alpha:1.000];
    CGFloat locations[4]={0.2,0.65,0.70,0.85};
//    CGFloat locations[5]={0.20,0.40,0.60,0.7,0.82,0.9,0.96,0.99};
     ...
     */
    CGContextDrawRadialGradient(context, gradient, CGPointMake((self.bounds.size.width - WIDTH)/2 + self.center.x, self.bounds.size.height/2),0, CGPointMake((self.bounds.size.width - WIDTH)/2 + self.center.x, self.bounds.size.height/2), 220, kCGGradientDrawsBeforeStartLocation);
    //释放颜色空间
    //    CGColorSpaceRelease(colorSpace);
}
